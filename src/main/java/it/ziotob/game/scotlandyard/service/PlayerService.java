...
public class PlayerService {
    ...
    private boolean noDetectivesInCell(List<Player> players, Long endPosition) {
        return players.stream().filter(Player::isDetective).map(Player::getPosition).noneMatch(position -> position.equals(endPosition));
    }
